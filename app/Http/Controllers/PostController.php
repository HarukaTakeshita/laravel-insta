...
class PostController extends Controller
{
    ...
    public function edit($id){
        ...
        // make an array of the post's categories (categoriy ids)
        $selected_categories = [];
        foreach($post_a->categoryPosts as $category_post){
            $selected_categories []= $category_post->category_id;
        }

        return view('user.posts.edit')->with('post', $post_a)->with('all_categories', $all_categories)->with('selected_categories', $selected_categories);
    }
